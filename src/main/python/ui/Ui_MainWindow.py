...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tw_shows_movies.setGeometry(QtCore.QRect(20, 460, 1311, 571))
        ...
        self.lw_movie_first_genre = QtWidgets.QListWidget(self.gridLayoutWidget)
        self.lw_movie_first_genre.setMinimumSize(QtCore.QSize(100, 0))
        self.lw_movie_first_genre.setMaximumSize(QtCore.QSize(100, 16777215))
        self.lw_movie_first_genre.setObjectName("lw_movie_first_genre")
        self.gridLayout_2.addWidget(self.lw_movie_first_genre, 1, 7, 1, 1)
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(10, 10, 1281, 521))
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(1400, 490, 471, 531))
        ...
        self.rb_3d.setMinimumSize(QtCore.QSize(60, 0))
        self.rb_3d.setMaximumSize(QtCore.QSize(60, 16777215))
        ...
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(20, 10, 1871, 31))
        ...
        self.gridLayout.addWidget(self.l_connection, 0, 1, 1, 1)
        self.hs_connection = QtWidgets.QSlider(self.gridLayoutWidget_4)
        self.hs_connection.setMinimumSize(QtCore.QSize(50, 0))
        self.hs_connection.setMaximumSize(QtCore.QSize(50, 16777215))
        ...
        self.gridLayout.addWidget(self.hs_connection, 0, 2, 1, 1)
        self.le_api_key = QtWidgets.QLineEdit(self.gridLayoutWidget_4)
        self.le_api_key.setMinimumSize(QtCore.QSize(400, 0))
        self.le_api_key.setMaximumSize(QtCore.QSize(400, 16777215))
        self.le_api_key.setObjectName("le_api_key")
        self.gridLayout.addWidget(self.le_api_key, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "Movie Title"))
        ...
        self.label_3.setText(_translate("MainWindow", "Show Name"))
