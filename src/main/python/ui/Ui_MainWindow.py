...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(20, 10, 1871, 34))
        ...
        self.gridLayout.addWidget(self.hs_connection, 0, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.l_connection, 0, 3, 1, 1)
        ...
        self.pb_connect = QtWidgets.QPushButton(self.gridLayoutWidget_4)
        self.pb_connect.setMinimumSize(QtCore.QSize(0, 31))
        self.pb_connect.setMaximumSize(QtCore.QSize(80, 31))
        self.pb_connect.setObjectName("pb_connect")
        self.gridLayout.addWidget(self.pb_connect, 0, 2, 1, 1)
